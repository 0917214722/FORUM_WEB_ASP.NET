...
namespace FORUM_WEB.Areas.Admin.Controllers
{
    public class TaiKhoansController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TenDangNhap,MatKhau,Avatar,SoLuongBaiDang,Roll,NgayGiaNhap")] TaiKhoan taiKhoan)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TenDangNhap,MatKhau,Avatar,SoLuongBaiDang,Roll,NgayGiaNhap")] TaiKhoan taiKhoan)
        {
            if (ModelState.IsValid)
            {
